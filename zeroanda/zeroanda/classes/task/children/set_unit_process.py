...
class SetUnitProcess(AbstractProcess):
    ...
    def _set_unit(self):
        self._task.pool['ask_unit'] = int(utils.get_max_units(int(self._task.pool['account_info_model'].balance), self._task.pool['price_model'].ask))
        self._task.pool['bid_unit'] = int(utils.get_max_units(int(self._task.pool['account_info_model'].balance), self._task.pool['price_model'].bid))
