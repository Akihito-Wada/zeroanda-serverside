...
POINT_MAP = (
    {
        "IFDOCO_ASK_ENTRY_POINT": 0,
        "ASK_UPPER_BOUND_PROFIT_MARGIN": 0.01,
        "ASK_LOWER_BOUND_PROFIT_MARGIN": -0.01,
        "ASK_STOP_LOSS_MARGIN": -0.005,
        "ASK_TAKE_PROFIT_MARGIN": 0.01,

        "IFDOCO_BID_ENTRY_POINT": 0,
        "BID_UPPER_BOUND_PROFIT_MARGIN": 0.01,
        "BID_LOWER_BOUND_PROFIT_MARGIN": -0.01,
        "BID_STOP_LOSS_MARGIN": 0.005,
        "BID_TAKE_PROFIT_MARGIN": -0.01,
    },
    {
    ...
    },
    {
        ...
        "ASK_STOP_LOSS_MARGIN": -0.08,
        "ASK_TAKE_PROFIT_MARGIN": 0.3,

        "IFDOCO_BID_ENTRY_POINT": -0.03,
        "BID_UPPER_BOUND_PROFIT_MARGIN": 0.2,
        "BID_LOWER_BOUND_PROFIT_MARGIN": -1,
        "BID_STOP_LOSS_MARGIN": 0.08,
        "BID_TAKE_PROFIT_MARGIN": -0.3,
    },
)