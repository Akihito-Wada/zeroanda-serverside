...
class TransactionModel(models.Model):
    ...
    account_balance= models.FloatField(default=0, blank=True, null=True)
    take_profit_price= models.FloatField(default=0, blank=True, null=True)
    upper_bound  = models.FloatField("成立上限価格", default=0)
    lower_bound  = models.FloatField("成立下限価格", default=0)
